...
SELECT models.name, brand_name, headquarters FROM models JOIN brands ON brand_name=brands.name WHERE brand_name = 'Ford' and models.name = 'Mustang'
;
...
SELECT models.name, brand_name, founded FROM brands FULL OUTER JOIN models ON brands.name=brand_name  WHERE year = '1960'
;
...
SELECT models.name, brand_name, founded FROM models JOIN brands ON brands.name=brand_name;
...
SELECT brands.name, founded FROM brands LEFT JOIN models ON brands.name=brand_name WHERE models.name IS NULL;
...
SELECT brands.name, models.name, year, discontinued, discontinued-year AS years_until_brand_discontinued FROM models LEFT JOIN brands ON brands.name=brand_name WHERE discontinued IS NOT NULL ORDER BY brands.name, models.name, year;
